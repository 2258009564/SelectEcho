...
| 翻译引擎模式 (`engineMode`)     | `auto` / `baidu` / `google`                               | `auto`    | 严格二选一         |
...
欢迎提 Issue / PR，一起完善 SelectEcho。

建议流程：

1. 先开 Issue 描述问题或需求。
2. Fork 并创建分支：`feat/...` 或 `fix/...`。
3. 完成自测后提交 PR，说明变更点与影响范围。
4. 通过 Review 后合并。

提交前请确认：

- 不破坏“百度/Google 二选一”策略。
- 文案与 README 说明保持一致。
- 关键逻辑有注释，便于后续维护。
